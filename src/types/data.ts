...
import type { coord_system } from 'src/types/cordinates';
import type { path, path_style } from 'src/types/path';
import type { HF_text, text_style } from 'src/types/text';
import type { Tile, TileSymbol } from 'src/types/tilesets';
